...
const Hero = () => {
  return (
    <section id="hem" className="relative bg-gradient-to-br from-orange-50 to-blue-50 py-20 lg:py-32">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2 text-orange-600">
                ...
                <span className="font-semibold">Välkommen till Bakgårdskatt</span>
              </div>
              <h2 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Ge katter en<br />
                <span className="text-orange-500">andra chans</span><br />
                till kärlek
              </h2>
            ...
            <div className="flex items-center space-x-8 pt-8">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Katter omplacerade</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-500">23</div>
                <div className="text-sm text-gray-600">Aktiva volontärer</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-500">5</div>
                <div className="text-sm text-gray-600">År av omsorg</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative z-10">
              <img
                ...
                alt="Söt grå kattunge som behöver ett hem"
